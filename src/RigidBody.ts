...
export class RigidBody extends gfx.Mesh3
{
    ...
    update(deltaTime: number): void
    {
        ...
        // ADD YOUR CODE HERE
        const gradvityAccel = new gfx.Vector3(0, RigidBody.gravity, 0);
        
        const adt = gfx.Vector3.multiplyScalar(gradvityAccel, deltaTime);
        this.velocity.add(adt);

        const vdt = gfx.Vector3.multiplyScalar(this.velocity, deltaTime);
        this.position.add(vdt);
